...
export default function ParticipantAScreen() {
  ...
  return (
    <ScrollView style={styles.container} keyboardShouldPersistTaps="handled">
      <ThemedText type="subtitle" style={styles.header}>Дані водія А та його авто</ThemedText>
      ...
      <TouchableOpacity style={styles.button} onPress={() => router.push('/homework/europrotocol/participantB')}>
        <ThemedText style={styles.buttonText}>Далі (Учасник Б)</ThemedText>
      </TouchableOpacity>
    </ScrollView>
  );
}
